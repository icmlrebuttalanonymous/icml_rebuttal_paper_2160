...
def main():
    ...
    parser.add_argument("--WW_metric_cache", default="./metric_cache")
    ...
    if args.wikitext:
        ...
        save_filepath = os.path.join(args.save, f"perplexity_{args.prune_method}_{args.WW_metric}_{args.epsilon}.txt")
    ...
    if args.eval_zero_shot:
        ...
        save_filepath = os.path.join(args.save, f"zero_shot_{args.prune_method}_{args.WW_metric}_{args.epsilon}.txt")
        with open(save_filepath, "w") as f:
